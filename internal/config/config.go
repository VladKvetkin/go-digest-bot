...
type Config struct {
	...
	DatabaseDSN          string        `hcl:"database_dsn" env:"DATABASE_DSN" default:"postgres://postgres:postgres@localhost:5432/go_digest_bot?sslmode=disable"`
	FetchInterval        time.Duration `hcl:"fetch_interval" env:"FETCH_INTERVAL" default:"10m"`
	NotificationInterval time.Duration `hcl:"notification_interval" env:"NOTIFICATION_INTERVAL" default:"30s"`
	FilterKeywords       []string      `hcl:"filter_keywords" env:"FILTER_KEYWORDS"`
	Ya300Endpoint        string        `hcl:"ya300_endpoint" env:"YA300_ENDPOINT"`
	Ya300Token           string        `hcl:"ya300_token" env:"YA300_TOKEN"`
}
